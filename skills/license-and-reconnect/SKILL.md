...
description: Map LICENSE_REQUIRED, REAUTH_REQUIRED, CONSENT_MISSING, GBP_NOT_ENABLED, WRITE_NOT_ENABLED, CONSENT_W_REQUIRED, ADS_SCOPE_MISSING, META_NOT_CONNECTED. Use when a paid tool failed, Google access expired, a scope was unchecked, writes are gated, or the user asks about Ads/Meta unlock. Free GA4/GSC/GTM keep working without a license.
---
