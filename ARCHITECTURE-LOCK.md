...
- Closed free kernel: the **22** tools named in SECOND-OPINION plus **`ga4_list_account_summaries`** plus **`gsc_describe_schema`** (24), plus Wave 13 **`gtm_list_clients`** plus **`gtm_list_environments`** (honest **26**). Version `0.1.0`.
