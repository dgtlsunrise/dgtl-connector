...
import { CONNECT_REQUIRED_SCOPES, CONSENT_A, FREE_GOOGLE_NEVER } from "./scopes";

const connectScopes = CONSENT_A.join(", ");
const neverScopes = FREE_GOOGLE_NEVER.join(", ");
const requiredScopes = CONNECT_REQUIRED_SCOPES.join(" and ");
